...
export const CounterpartiesPublicSchema = {
    properties: {
        data: {
            items: {
                $ref: '#/components/schemas/CounterpartyPublic'
            },
            type: 'array',
            title: 'Data'
        },
    ...
    title: 'CounterpartiesPublic'
} as const;

export const CounterpartyAssignmentSchema = {
    properties: {
        counterparty_id: {
            anyOf: [
                {
...
export const CounterpartyCreateSchema = {
    ...
    title: 'CounterpartyCreate'
} as const;

export const CounterpartyPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    title: 'CounterpartyPublic'
} as const;

export const CounterpartySearchPublicSchema = {
    properties: {
        items: {
            items: {
                $ref: '#/components/schemas/CounterpartySummaryPublic'
    ...
    title: 'CounterpartySearchPublic'
} as const;

export const CounterpartySummaryPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    title: 'CounterpartySummaryPublic'
} as const;

export const CounterpartyUpdateSchema = {
    properties: {
        name: {
            anyOf: [
                {
...
export const IntegrationCreatedSchema = {
    properties: {
        integration: {
            $ref: '#/components/schemas/IntegrationPublic'
        },
        credential: {
            $ref: '#/components/schemas/IntegrationCredentialPublic'
        },
        connection_key: {
            type: 'string',
...
export const IntegrationCredentialCreatedSchema = {
    ...
    title: 'IntegrationCredentialCreated'
} as const;

export const IntegrationCredentialPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    title: 'IntegrationCredentialPublic'
} as const;
